...
const MemorizeAPIContext = React.createContext<Context>({
  people: [],
  isLoading: false,
  refetch: () => Promise.resolve([] as People)
});

const MemorizeAPIContextProvider: React.FC = ({ children }) => {
  // make api call here
...
export { MemorizeAPIContextProvider, MemorizeAPIContext };
